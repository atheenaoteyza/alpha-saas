const RemoveVideoIcon = () => (
  <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" fill="none">
    ...
    {/* Optional background white triangle shape */}
    <path
      d="M106.64 88.63c-5.53 3.52-3.88 75.56-.68 79.8s63.75-34 63.8-40.81-57.58-42.51-63.12-38.99z"
      fill="#ffffff"
    />

    {/* Error sign in the center (circle + exclamation mark) */}
    <g transform="translate(210, 46)">
      <circle r="50" fill="white" stroke="#e83a2a" strokeWidth="4" />
      <text
        x="0"
        y="7"
        textAnchor="middle"
